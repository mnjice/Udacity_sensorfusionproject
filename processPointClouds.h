...
namespace lidar_obstacle_detection{
    ...
    public:
        ...
        std::pair<PtCdtr<PointT>, PtCdtr<PointT>> RansacSegmentPlane(PtCdtr<PointT> cloud, int maxIterations, float distanceThreshold);

        std::pair<PtCdtr<PointT>, PtCdtr<PointT>> SegmentPlane(PtCdtr<PointT> cloud, int maxIterations, float distanceThreshold);
